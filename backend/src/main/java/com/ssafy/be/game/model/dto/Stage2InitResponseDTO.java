...
public class Stage2InitResponseDTO extends SocketDTO {
    private int gameId;
    private int round;
    private int stage;
    private List<HintComponent> hints;

    public Stage2InitResponseDTO(LocalDateTime senderDateTime, String senderNickname, int senderGameId, int senderTeamId, int code, String msg) {
